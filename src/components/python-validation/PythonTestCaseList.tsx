...
import { PythonTestCaseCard } from './PythonTestCaseCard';
import type { PythonTestCase } from './types';

interface PythonTestCaseListProps {
...
export function PythonTestCaseList({ testCases, onAdd, onEdit, onDelete }: PythonTestCaseListProps) {
  return (
    <div>
